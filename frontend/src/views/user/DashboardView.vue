...
import UserDashboardActiveGroups from '@/components/user/dashboard/UserDashboardActiveGroups.vue'
...
const refreshAll = () => { loadStats(); loadCharts() }
