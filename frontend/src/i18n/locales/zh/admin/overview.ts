export default {
    ...
    groups: {
      ...
      createGroup: '创建分组',
      setCategory: '设置分类',
      setCategoryTitle: '设置分组分类',
      setCategoryHint: '为分组「{name}」选择一个分类',
      setCategoryPlaceholder: '选择分类',
      setCategoryNone: '不设置分类',
      setCategorySuccess: '分类已保存',
      setCategoryFailed: '保存分类失败',
      categories: {
        title: '分类管理',
        description: '创建、编辑或删除分组分类，可拖拽调整显示顺序',
        create: '新建分类',
        edit: '编辑分类',
        name: '分类名称',
        namePlaceholder: '例如：推荐、高性价比',
        descriptionLabel: '说明',
        descriptionPlaceholder: '可选，展示给管理员的分类说明',
        sortOrder: '排序',
        sortOrderHint: '拖拽分类调整顺序，排在前面的分类在选分组时优先显示',
        sortOrderUpdated: '分类顺序已更新',
        failedToUpdateSortOrder: '更新分类顺序失败',
        deleteConfirm: "确定删除分类「{name}」吗？已绑定该分类的分组会取消分类。",
        created: '分类已创建',
        updated: '分类已更新',
        deleted: '分类已删除',
        failedToLoad: '加载分类失败',
