export default {
    ...
    channelMonitor: {
      ...
      visibility: {
        title: 'User-facing channel status visibility',
        description: 'Choose who can open Channel Status. Admins always have access.',
        all: 'Visible to everyone',
        allHint: 'Every signed-in user can open Channel Status.',
        selected: 'Visible to selected users',
        selectedHint: 'Only listed users can open Channel Status. Others lose the nav entry and APIs. Admins are not restricted.',
        ...
        saveSuccess: 'Channel status visibility saved',
        saveFailed: 'Failed to save visibility',
        saveNotPersisted: 'The server did not persist visibility settings. Update the backend and try again.',
        loadFailed: 'Failed to load visibility settings',
        selectedCount: '{count} users selected',
        emptySelected: 'No users selected; only admins can see Channel Status.',
      },
      advanced: {
