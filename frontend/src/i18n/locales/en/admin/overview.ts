export default {
    ...
    groups: {
      ...
      setCategoryTitle: 'Set group category',
      setCategoryHint: 'Choose a category for "{name}"',
      setCategoryPlaceholder: 'Select a category',
      setCategoryNone: 'No category',
      setCategorySuccess: 'Category saved',
      setCategoryFailed: 'Failed to save category',
      categories: {
        title: 'Categories',
        description: 'Create, edit, or delete group categories. Drag to change display order.',
        create: 'New category',
        edit: 'Edit category',
        name: 'Name',
        namePlaceholder: 'e.g. Featured, Value',
        descriptionLabel: 'Description',
        descriptionPlaceholder: 'Optional note for admins',
        sortOrder: 'Sort',
        sortOrderHint: 'Drag categories to change order. Higher items appear first in the group picker.',
        sortOrderUpdated: 'Category order updated',
        failedToUpdateSortOrder: 'Failed to update category order',
        deleteConfirm: 'Delete category "{name}"? Groups using it will be unassigned.',
